...
const NewsItem = (props) => {
    ...
    return (
      <div>
        <div className="card my-3" style={{width: "300px", height: "445px"} } >
        <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger badge" style={{left: '80%', zIndex: '1', color: 'white'}}>{source}
        </span>
